...
export default () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="900px" height="800px">
    <defs>
    ...
    <g fill="none" fill-rule="evenodd">
      ...
      <g transform="translate(706 218)">
        <use fill="#000" filter="url(#h)" href="#i" />
        <use fill="#FFF" href="#i" />
      </g>
      <g transform="translate(706 218)">
        <use fill="#000" filter="url(#j)" href="#k" />
        <use fill="#00252E" href="#k" />
      </g>
